...
CGeometryGenerator::SMeshData CGeometryGenerator::CreateBox(float width, float height, float depth, uint32 numSubdivisions)
{
    SMeshData meshData;
...
CGeometryGenerator::SMeshData CGeometryGenerator::CreateSphere(float radius, uint32 sliceCount, uint32 stackCount)
{
    SMeshData meshData;
...
void CGeometryGenerator::Subdivide(SMeshData& meshData)
{
...
CGeometryGenerator::SVertex CGeometryGenerator::MidPoint(const SVertex& v0, const SVertex& v1)
{
...
CGeometryGenerator::SMeshData CGeometryGenerator::CreateGeosphere(float radius, uint32 numSubdivisions)
{
    SMeshData meshData;
...
CGeometryGenerator::SMeshData CGeometryGenerator::CreateCylinder(float bottomRadius, float topRadius, float height, uint32 sliceCount, uint32 stackCount)
{
    SMeshData meshData;
...
void CGeometryGenerator::BuildCylinderTopCap(float bottomRadius, float topRadius, float height,
											uint32 sliceCount, uint32 stackCount, SMeshData& meshData)
{
...
CGeometryGenerator::SMeshData CGeometryGenerator::CreateGrid(float width, float depth, uint32 m, uint32 n)
{
    SMeshData meshData;
...
CGeometryGenerator::SMeshData CGeometryGenerator::CreateQuad(float x, float y, float w, float h, float depth)
{
    SMeshData meshData;
