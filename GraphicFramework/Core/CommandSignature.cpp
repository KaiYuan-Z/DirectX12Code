...
void CCommandSignature::Finalize( const CRootSignature* RootSignature )
{
    if (m_Finalized)
        return;
    ...
    ASSERT_SUCCEEDED(GraphicsCore::GetD3DDevice()->CreateCommandSignature(&CommandSignatureDesc, pRootSig,
