...
public:
	...
	void CalculateAccumMap(CColorBuffer* pPreLinearDepthBuffer, CColorBuffer* pCurLinearDepthBuffer, CColorBuffer* pMotionBuffer, CGraphicsCommandList* pGraphicsCommandList);
