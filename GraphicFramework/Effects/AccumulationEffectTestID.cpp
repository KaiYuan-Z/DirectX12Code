...
#include "AccumulationEffectTestID.h"

#include "CompiledShaders/AccumulationEffectVS.h"
#include "CompiledShaders/AccumulationEffectAccumMapPSTestID.h"
#include "CompiledShaders/AccumulationEffectAccumRedPS.h"


CAccumulationEffectTestID::CAccumulationEffectTestID()
{
}
...
void CAccumulationEffectTestID::Init(DXGI_FORMAT frameFormat, UINT frameWidth, UINT frameHeight)
{
...
void CAccumulationEffectTestID::OnFrameUpdate(const CCameraBasic* pCamera)
{
	m_AccumulationMapCB.View = pCamera->GetViewXMM();
...
void CAccumulationEffectTestID::CalculateAccumMap(CColorBuffer* pPreIdBuffer, CColorBuffer* pCurIdBuffer, CColorBuffer* pMotionBuffer, CGraphicsCommandList * pGraphicsCommandList)
{
	_ASSERTE(pGraphicsCommandList);
	__VerifySRV(pPreIdBuffer);
	__VerifySRV(pCurIdBuffer);
	__VerifySRV(pMotionBuffer);

	pGraphicsCommandList->TransitionResource(*pPreIdBuffer, D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE, false);
	pGraphicsCommandList->TransitionResource(*pCurIdBuffer, D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE, false);
	...
	pGraphicsCommandList->SetDynamicDescriptor(1, 0, pPreIdBuffer->GetSRV());
	pGraphicsCommandList->SetDynamicDescriptor(2, 0, pCurIdBuffer->GetSRV());
...
void CAccumulationEffectTestID::AccumulateFrame(CColorBuffer* pCurFrameBuffer, CColorBuffer* pMotionBuffer, CGraphicsCommandList* pGraphicsCommandList)
{
	_ASSERTE(pGraphicsCommandList);
...
void CAccumulationEffectTestID::__InitQuadGeomtry()
{
...
void CAccumulationEffectTestID::__BuildRootSignature()
{
...
void CAccumulationEffectTestID::__BuildPSO()
{
	...
	m_PsoAccumMap.SetPixelShader(g_pAccumulationEffectAccumMapPSTestID, sizeof(g_pAccumulationEffectAccumMapPSTestID));
...
void CAccumulationEffectTestID::__BuildMaps(UINT frameWidth, UINT frameHeight)
{
...
void CAccumulationEffectTestID::__VerifySRV(const CPixelBuffer* pSRV)
{
